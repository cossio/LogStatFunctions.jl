...
3. Derive one suggested version from the highest bump required by the accumulated changes. Treat the `-DEV` version in Project.toml only as a hint — e.g. `2.1.1-DEV` may have accumulated features that suggest `2.2.0`.
